...
PlutoTeachingTools.protip_invite_str(lang::Lang) where {Lang <: English} = "Want to see the answer?"
PlutoTeachingTools.protip_boxlabel_str(lang::Lang) where {Lang <: English} = "Answer"
