...
PlutoTeachingTools.answer_invite_str(lang::Lang) where {Lang <: English} = "Willst du die Antwort sehen?"
PlutoTeachingTools.answer_boxlabel_str(lang::Lang) where {Lang <: English} = "Antwort"
